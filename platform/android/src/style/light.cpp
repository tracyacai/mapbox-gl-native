...
void Light::setAnchor(jni::JNIEnv&, PropertyValue<LightAnchorType>& property) {
    light.setAnchor(property);
}

void Light::setPosition(jni::JNIEnv&, PropertyValue<Position>& property) {
...
void Light::setColor(jni::JNIEnv&, PropertyValue<Color>& property) {
...
void Light::setIntensity(jni::JNIEnv&, PropertyValue<float>& property) {
